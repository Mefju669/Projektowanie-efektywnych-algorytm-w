...
int main(int argc, char* argv[])
{
    ...
    do
    {
        ...
        case '1':
            ...
            cout << endl;
            cout<<"Podaj dlugosc epoki (wielokrotność rozmiaru sąsiedztwa): "<<endl;
            cin>> dlugoscEpoki;
            cout<<endl;
            cout<<"Wybor sasiedztwa 2-zamiana czy losowe przemieszczenie z/l: "<<endl;
            cin>> sasiedztwo;

            myAlgorytm.sAlgorithm(dlugoscEpoki, sasiedztwo);
            break;
